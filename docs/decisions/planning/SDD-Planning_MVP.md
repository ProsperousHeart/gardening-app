...
These files contain high-level systems design artifacts:
...
2. **CommunityMember** (medium priority) - Community garden collaboration
...
### Phase 1: Core Plant Database (Weeks 1-2)
...
### Phase 2: Supporting Calculations & Data (Week 3)
...
### Phase 4: User Data & Feedback (Week 5)
...
- Save favorite plants locally/cloud
- Request new plants for database

### Phase 5: Advanced General Features (Week 6)
...
- Track common pests and organic treatments

### Phase 6: Community Features (Weeks 7-9)
...
- Secure community-specific access
- Plot tracking and assignment
...
#### Phase 7: Admin Features (Week 10+) - DEFERRED
