...
# UserMgmt Requirements

## About UserMgmt Component

This section contains requirements specific to the **UserMgmt** subsystem.

**Naming Convention:**

- **File name**: `req-usermgmt-[component-name].md`
- **req_id**: `req-usermgmt-[component-name]`
- **Example**: `req-usermgmt-plant-database.md` with `req_id: req-usermgmt-plant-database`
