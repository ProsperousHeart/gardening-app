...
# CommunityMember Requirements

## About CommunityMember Component

This section contains requirements specific to the **CommunityMember** subsystem.

**Naming Convention:**

- **File name**: `req-communitymember-[component-name].md`
- **req_id**: `req-communitymember-[component-name]`
- **Example**: `req-communitymember-plant-database.md` with `req_id: req-communitymember-plant-database`
